  ...
  return (
    <div className="main-menu">
      ...
      <AccordionMenu id={1} path="/other" title="Me Stuff">
        ...
        <CustomNavLink to="/other/artists/kelly-boesch">Kelly Boesch</CustomNavLink>
      ...
      <AccordionMenu id={4} title="Programming Principals">
        ...
        <CustomNavLink to="/programming/design-patterns" ariaLabel="Design Patterns">
          Design Patterns
        </CustomNavLink>
        <CustomNavLink
      ...
      <AccordionMenu id={6} title="CSS & Design">
        ...
        <CustomNavLink to="/design/responsive-design" ariaLabel="Responsive Design">
          Responsive Design
        </CustomNavLink>
        <CustomNavLink to="/design/material-design">Material Design</CustomNavLink>
        ...
        <CustomNavLink to="/design/parallax-scrolling">Parallax Ccrolling</CustomNavLink>
        <CustomNavLink to="/design/kinetic-typography">Kinetic Typography</CustomNavLink>
        <CustomNavLink to="/design/microinteractions">Microinteractions</CustomNavLink>
      ...
      <AccordionMenu id={7} title="Design Styles">
        <CustomNavLink to="/styles/corporate-memphis">Corporate Memphis</CustomNavLink>
