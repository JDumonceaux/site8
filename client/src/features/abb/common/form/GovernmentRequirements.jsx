...
const GovernmentRequirements = props => {
    ...
    const localValues = {
        domesticPreference: domesticPreference
            ? domesticPreference
            : domesticPreferenceState,
        dpoDisabled: dpoDisabled ? dpoDisabled : temporaryGFA === "dpo",
        governmentFundedAnswer: governmentFundedAnswer
            ? governmentFundedAnswer
            : (value
            ? value
            : temporaryGFA),
        govFundedNoDisabled: govFundedNoDisabled
            ? govFundedNoDisabled
            : temporaryGFA === "no",
        govFundedYesDisabled: govFundedYesDisabled
            ? govFundedYesDisabled
            : temporaryGFA === "yes",
        isExternal: isExternal ? isExternal : isExternalState
    };
            ...
            case "no": {
                if (isOrder) {
                    return localValues.isExternal
                        ? msgFormatter(
                              "governmentRequirementsOrderNoExternal"
                          )()
      ...
      <div>
        ...
        <div className="radio-mandatory-container">
          <div className="radio-group">
            <RadioButton
              checked={
                                localValues.governmentFundedAnswer === "yes"
                            }
          ...
          <div className="radio-group">
            <RadioButton
              checked={
                                localValues.governmentFundedAnswer === "no"
                            }
          ...
          {(localValues.domesticPreference ||
                        localValues.isExternal) ? (
                          <div className="radio-group">
                            <RadioButton
                              checked={
                                    localValues.governmentFundedAnswer === "dpo"
                                }
