...
// ActionsMenu: Renders a menu of action icons using SlideoutMenu and IconsMenu
const ActionsMenu = ({ items }) => {
  ...
  return (
    <WrapperDiv>
      <StyledMenu>
        <SlideoutMenu>
          {/* Note: SlideoutMenu already includes a UL wrapper, so includeUL is set to false. */}
          <IconsMenu
            includeLI
            includeUL={false}
            items={validItems}
