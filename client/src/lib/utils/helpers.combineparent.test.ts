...
describe('combineParent', () => {
  ...
  it('should return "1,2,3,4,5,6" for a valid input array', () => {
    const input = [
      { id: 1, seq: 2 },
      { id: 3, seq: 4 },
      { id: 5, seq: 6 },
  ...
  it('should return "1,2,3,4" for an input array with undefined values', () => {
    const input = [
      { id: 1, seq: 2 },
      { id: undefined, seq: 4 },
      { id: 3, seq: undefined },
  ...
  it('should return "0,0" for an undefined input', () => {
