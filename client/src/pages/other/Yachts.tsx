    ...
    <TwoColumn
      ...
      left={
        <section className="section">
          <p>
            The design of this yacht is called <em>Nature</em> by{" "}
          ...
          <p>
            ...
            hand. Large doors fold down from the sides - becoming decks from
            which you can dangle your feet in warm waters.
          </p>
          <p>
            Sinot has a range of other beautiful designs:{" "}
