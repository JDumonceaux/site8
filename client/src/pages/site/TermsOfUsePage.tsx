...
const TermsOfUsePage = (): JSX.Element => {
  ...
  return (
    <>
      <Meta title={title} />
      <div>
        TERMS OF USE Last updated March 21, 2024 AGREEMENT TO OUR LEGAL TERMS We
        are X (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
        &quot;our&quot;). We operate the website example.com (the
        ...
        __________ or by mail to __________, __________, __________. These Legal
        Terms constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity (&quot;you&quot;), and X,
        ...
        conditions or documents that may be posted on the Services from time to
        ...
        these Legal Terms from time to time. We will alert you about any changes
