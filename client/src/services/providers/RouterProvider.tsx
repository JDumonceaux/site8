...
const ImageLinkExample = lazy(() => import('../../pages/examples/ImageLinkExample'));
    ...
    <Route path="/">
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route path="react" element={<MainLayout />}>
          ...
          />
          <Route path="tutorial">
            <Route path="1" element={<GenericPage id={1} pageTitle="React Tutorial" />} />
            <Route
              path="2"
        ...
        <Route path="ide" element={<MainLayout />}>
          ...
          />
          <Route path="git" element={<GenericPage id={2002} pageTitle="GIT" />} />
          <Route
            path="vsc"
          ...
          <Route
            path="vsc/extensions"
            element={<GenericPage id={2004} pageTitle="Visual Studio Code: Extensions" />}
          />
          <Route
            path="vsc/help"
          ...
          <Route path="github" element={<GenericPage id={57} pageTitle="GitHub" />} />
          <Route
            path="aws/commit"
        ...
        <Route path="design" element={<MainLayout />}>
          <Route path="css" element={<GenericPage id={900} pageTitle="CSS Overview" />} />
          <Route
        ...
        <Route path="programming" element={<MainLayout />}>
          ...
          />
          <Route path="solid" element={<GenericPage id={0} pageTitle="SOLID" />} />
          <Route
        ...
        <Route path="other" element={<MainLayout />}>
          ...
          <Route
            path="at-last"
            element={<GenericPage id={3001} pageTitle="At Last - Pleasantville" />}
          />
          <Route path="gallos" element={<GenericPage id={3002} pageTitle="Gallos" />} />
          <Route
            path="shoes-on-the-danube-bank"
            element={<GenericPage id={3003} pageTitle="Shoes on the Danube Bank" />}
          />
          ...
          <Route
            path="puzzles2"
            element={<GenericPage id={5002} pageTitle="Puzzles - The Puzzle Lab" />}
          />
        </Route>
        {/* ADMIN */}
