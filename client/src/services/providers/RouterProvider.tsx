    ...
    <Route path="/">
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route
          ...
          <Route
            ...
            element={
              <GenericPage
                id={54}
                pageTitle="Visual Studio Code: Help"
              />
            }
          />
          <Route
        ...
        <Route
          ...
          <Route
            ...
            element={
              <GenericPage
                id={0}
                pageTitle="Programming Challenges"
              />
            }
          />
        </Route>
        ...
        <Route
          ...
          <Route
            ...
            element={
              <GenericPage
                id={3001}
                pageTitle="At Last - Pleasantville"
              />
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <GenericPage
                id={3003}
                pageTitle="Shoes on the Danube Bank"
              />
            }
          />
          ...
          <Route
            ...
            element={
              <GenericPage
                id={5002}
                pageTitle="Puzzles - The Puzzle Lab"
              />
            }
          />
        </Route>
        ...
        <Route
          ...
          <Route
            path="form/1"
            element={<FormExample1 />}
          />
          <Route
            path="form/2"
            element={<FormExample2 />}
          />
        </Route>
      </Route>
    </Route>,
